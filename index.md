...
* **Lectures**: 5:00-8:00 pm East Time on Wednesdays (online)
* **Lecture videos for enrolled students**: are posted on XXXX (requires login) shortly after each lecture ends. Unfortunately, it is not possible to make these videos viewable by non-enrolled students. 
* **Email office hours**: 
  * I will respond to student email messages between 4:00 and 5:00 pm on Tuesdays and Thursdays.
* **Office hours**:
  * **Time**: 4:00-5:00 pm on Mondays, or by appointment.
  * **Attending remotely**: I will send you a zoom chat link during office hours.
  * **Contact**: Students should ask all course-related questions in the XXXX, where you will also find announcements. For external inquiries, emergencies, or personal matters that you don't wish to put in a private XXXX, you can email me at yip4002@med.cornell.edu.
* **Instructors**
  * [Yifan Peng](http://vivo.med.cornell.edu/display/cwid-yip4002)
...
In this course, students will gain a thorough introduction to NLP applications and cutting-edge research in Deep Learning for NLP. Through lectures, assignments, and a final project, students will learn the necessary skills to design, implement, and understand their NLP models.
...
* **Attending two random lectures**: 
  * At two randomly-selected (non-guest) lectures in the quarter, we will take attendance. You will get 5% per lecture (10% total). 
...
* **Attending guest speakers' lectures**: 
  ...
  * You will get 5% per lecture (15% total). 
  * If you miss these two lectures, you can get 2.5% per lecture (7.5% total) by writing a ‘reaction paragraph’.
* **Completing feedback surveys**: We will send out two feedback surveys (mid-quarter and end-of-quarter) to help us understand how the course is going, and how we can improve. You can get 5% for each survey (10% total).
...
* **Credit**: Each is worth 10% (30% total)
...
* **Credit**: For both default and custom projects, credit for the final project is broken down as follows: 
  ...
  * Project oral presentation (5%) [instructions] 
  * Project report (10%) [instructions] 
* **Deadlines**: The project proposal and report are all due at 5:00 pm. All deadlines are listed in the schedule.
* **Default Final Project**: In this project, students explore deep learning solutions to the SQuAD (Stanford Question Asking Dataset) challenge. This year's project is similar to last year's, on SQuAD 2.0 with baseline code in PyTorch. 
...
|     7       |     Parsing                                                     |                           |                               |
|     8       |     Language understanding                                      |     Assignment 2          |     Project   Proposal due    |
|     9       |     Guest lecture:   biomedical literature text mining (NIH)    |                           |                               |
|     10      |     Intro to deep   learning and word vector                    |     Assignment 3          |     Assignment 2 due          |
|     11      |     Language   Generation: LSTM                                 |                           |                               |
|     12      |     Guest lecture:   Clinical NLP (Mayo)                        |                           |     Assignment 3 due          |
|     13      |     Transfer   learning and BERT                                |                           |                               |
|     14      |     Guest lecture:   TBD                                        |                           |                               |
|     15      |     Final   project poster session                              |                           |                               |
